...
template <typename T, typename color_type, typename size_type>
dispmanx_pixmap<T, color_type, size_type>::dispmanx_pixmap(size_type width,
                                                           size_type height)
...
template <typename T, typename color_type, typename size_type>
template <size_type align_to>
constexpr size_type dispmanx_pixmap<T, color_type, size_type>::align(
...
template <typename T, typename color_type, typename size_type>
const color_type *dispmanx_pixmap<T, color_type, size_type>::operator[](
    size_type index) const {
    return m_data.get() + index * pitch();
}

template <typename T, typename color_type, typename size_type>
color_type *dispmanx_pixmap<T, color_type, size_type>::operator[](
    size_type index) {
    return m_data.get() + index * pitch();
}
...
using dispmanx_pixmap =
    detail::dispmanx_pixmap<detail::bcm_host_type, color_type, size_type>;
}  // namespace bcm_host_wrapper
